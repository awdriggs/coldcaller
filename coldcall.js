...
var finchesList = ['ALI', 'ALYSON', 'ANDERSON', 'ANGEL', 'BESS', 'DANIEL', 'ELIYAH', 'GABRIEL', 'GILLIAN', 'IAN', 'JALEN', 'JAYDEN', 'JORDAN', 'JOSEPH', 'LOLA', 'MAGGIE', 'MALEZIA', 'MARLEE', 'MAROOF', 'MATEO', 'MEHRAB', 'MELA', 'OLIVER', 'ROOS', 'RUPA', 'SAMUEL', 'THELMA', 'TIGER', 'YAHRO', 'ZIGUAN']
var warblersList = ['AIDAN', 'AIDEN', 'AIMEE', 'ALEXANDER', 'BENICIO', 'BRADY', 'BRANDON', 'BROOKE', 'CHARLES', 'ELIJAH', 'ELIZA', 'ELLA', 'EVELYN', 'FRANCES', 'GRACE', 'JOAQUIN', 'KENNY', 'LIDHIA', 'LILLIAN', 'MARCO', 'MARTINA', 'MATEEN', 'MATTOX', 'MELINA', 'MICHAEL', 'NAWFOL', 'NYKAI', 'SCOTT', 'STELLA', 'THOR']
