...
var swiftsList = ['Adrian','Anthony','Caleb','Charlotte W','Charlotte H','Daisy','Dania','Dashiell','Ethan','Ewan','Genesis','Henry','Isaiah','James P','James C','Jayleen','Jehan','Julien','Melissa','Millie','Mirna','Newt','Noah', 'Dash'];
...
var robinsList = ['Bari','Adrian','Artur','Audrey','Clara','Daniel','Delphine','Dilnura','Emily','Evan','Georgia','Jancarlos','Joshua','Julien','Lucas','Luis','Mae','Mark','Mia','Richard','Roan','Samuel','Sebastian', 'Sylvia', 'Umme', 'Shayla', 'Teo'];
